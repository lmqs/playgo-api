...
import { makeAddTournamentSponsorController, makeLoadByTournamentIdTournamentSponsorController, makeRemoveTournamentSponsorController } from '@/main/factories/controllers/tournament-sponsor'
